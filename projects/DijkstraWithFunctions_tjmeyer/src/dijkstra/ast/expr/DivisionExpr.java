...
public class DivisionExpr extends ExprAST
{
	private final ExprAST f, l;
	
	public DivisionExpr(ExprAST first, ExprAST last)
	{
		f = first;
		l = last;
	}
	...
	public void buildTUT(TypeUnificationTable tut)
	{
		...
		tut.register(this, Type.FLOAT);
	}
	
	@Override
	public ExprAST renameVars(Set<VarBind> s)
	{
		return new DivisionExpr(f.renameVars(s), l.renameVars(s));
	}
